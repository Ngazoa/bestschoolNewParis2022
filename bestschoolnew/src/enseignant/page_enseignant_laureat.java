 ...
 * @author Junior ENAMA
 */
public class page_enseignant_laureat extends javax.swing.JFrame {
...
private String[] tclasse;
    public page_enseignant_laureat() {
        initComponents();
    }
...
*/
    ...
    private void classeItemStateChanged(java.awt.event.ItemEvent evt) {                                        
     ...
     if(!value.equals("Classes diponibles")){
                ...
                try {
                    ...
                    Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
...
this.setExtendedState(page_enseignant_laureat.MAXIMIZED_BOTH);
        disciplines.setEnabled(false);   
        try {   
 ...
 //jMenu1
              ...
              sequence1 = new  JMenu("TRIMESTRE 1");
                ...
                sequence3 = new  JMenu("TRIMESTRE 3");
                 cc1 = new  JMenuItem("CC 1");
                cc2 = new  JMenuItem("CC 2");
                cc3 = new  JMenuItem("CC 3");
                cc4 = new  JMenuItem("CC 4");
                cc5 = new  JMenuItem("CC 5");
                cc6 = new  JMenuItem("CC 6");
                cc7 = new  JMenuItem("COMPOS 1");
                cc8 = new  JMenuItem("COMPOS 2");
                cc9 = new  JMenuItem("COMPOS 3");
...
memoire.choix_sequence="cc1";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 1: "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="cc1";
...
memoire.choix_sequence="cc2";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 2: "+disciplines.getSelectedItem().toString());
...
memoire.choix_sequence="cc3";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 3: "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="cc3";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
 ...
 public void actionPerformed(java.awt.event.ActionEvent e) {
    ...
    String value = classe.getSelectedItem().toString();
memoire.choix_sequence="cc4";
   if(value.equals("Classes diponibles")){
                  JOptionPane.showMessageDialog(null,"Veuillez séléctionner votre classe\n pour continuer");
   }else{     if(!disciplines.getSelectedItem().toString().trim().equals("")){

       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 4: "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="cc4";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="cc5";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 5: "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="cc5";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="cc6";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de CC 6: "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="cc6";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="dev1";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de Composition 1 : "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="dev1";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="dev2";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de Composition 2 : "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="dev2";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="dev3";
   if(value.equals("Classes diponibles")){
       ...
       final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
            try {      memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de Composition 3 : "+disciplines.getSelectedItem().toString());
                memoire.numero_sequence="dev3";
                liste_eleve_par_classe1(list_des_elevs_par_classe);
            } catch (IOException ex) {
                Logger.getLogger(page_enseignant_laureat.class.getName()).log(Level.SEVERE, null, ex);
            } catch (JSONException ex) {
...
memoire.choix_sequence="ds9";
   ...
   if(value.equals("Classes diponibles")){
       ...
       try {        memoire.classe=list_des_elevs_par_classe;
         trait.setText("Notes de : "+disciplines.getSelectedItem().toString()+" pour la sequence 2");
                ...
                liste_eleve_par_classe1(list_des_elevs_par_classe);                } catch (IOException ex) {
 ...
 public void actionPerformed(java.awt.event.ActionEvent e) {
   ...
   if(value.equals("Classes diponibles")){
                  JOptionPane.showMessageDialog(null,"Veuillez séléctionner votre classe\n à saisir les pour pouvoir continuer");
   }else{      final String list_des_elevs_par_classe =classe.getSelectedItem().toString();
...
// TODO add your handling code here:
    ...
    private void disciplinesActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           
...
ArrayList<String> co = new ArrayList<String>();
    for (int i = 0; i < count; i++) {
      ...
      try{ 
       ...
       }catch(Exception ex){         memoire.decision=1;
...
ArrayList<String> co = new ArrayList<String>();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page_enseignant_laureat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new page_enseignant_laureat().setVisible(true);
            }
        });
    }
