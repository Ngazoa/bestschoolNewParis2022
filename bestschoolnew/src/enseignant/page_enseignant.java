 ...
 */
public class page_enseignant extends javax.swing.JFrame {
...
*/
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        this.setExtendedState(page_enseignant.MAXIMIZED_BOTH);
        disciplines.setEnabled(false);
        try {
        ...
        saves = new JMenu("                                                                                                Enregistrer notes");
        ...
        cc7 = new JMenuItem("CC 7");
        cc8 = new JMenuItem("CC 8");
        cc9 = new JMenuItem("CC 9");
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (value.equals("Classes diponibles")) {
                    ...
                    if (!disciplines.getSelectedItem().toString().trim().equals("")) {
                        ...
                        try {
                            memoire.classe = list_des_elevs_par_classe;
                            trait.setText("Notes de CC 7: " + disciplines.getSelectedItem().toString());
                            memoire.numero_sequence = "cc7";
                            liste_eleve_par_classe1(list_des_elevs_par_classe);
                        } catch (IOException ex) {
                            Logger.getLogger(page_enseignant.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (JSONException ex) {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (value.equals("Classes diponibles")) {
                    ...
                    if (!disciplines.getSelectedItem().toString().trim().equals("")) {
                        ...
                        try {
                            memoire.classe = list_des_elevs_par_classe;
                            trait.setText("Notes de CC 8: " + disciplines.getSelectedItem().toString());
                            memoire.numero_sequence = "cc8";
                            liste_eleve_par_classe1(list_des_elevs_par_classe);
                        } catch (IOException ex) {
                            Logger.getLogger(page_enseignant.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (JSONException ex) {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (value.equals("Classes diponibles")) {
                    ...
                    if (!disciplines.getSelectedItem().toString().trim().equals("")) {
                        ...
                        try {
                            memoire.classe = list_des_elevs_par_classe;
                            trait.setText("Notes de CC 9: " + disciplines.getSelectedItem().toString());
                            memoire.numero_sequence = "cc9";
                            liste_eleve_par_classe1(list_des_elevs_par_classe);
                        } catch (IOException ex) {
                            Logger.getLogger(page_enseignant.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (JSONException ex) {
...
//         String pass = detail.getnote();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page_enseignant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
