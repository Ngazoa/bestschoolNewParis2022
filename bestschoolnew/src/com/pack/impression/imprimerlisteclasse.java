 ...
 * @author Benito
 */
public class imprimerlisteclasse extends JPanel implements Printable {

    List<impressionmodel_11> eleves = new ArrayList<impressionmodel_11>();
    int comp = 29;

    public imprimerlisteclasse(List<impressionmodel_11> eleve) {
        eleves = eleve;
        PrinterJob pj = PrinterJob.getPrinterJob();
        pj.setPrintable(imprimerlisteclasse.this);
        pj.printDialog();
        try {
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2.drawString("Liste élève classe de : " + memoire.classe, 115, 190);
        g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
