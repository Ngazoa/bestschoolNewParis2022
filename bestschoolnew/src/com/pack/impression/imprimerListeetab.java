 ...
 * @author Benito
 */
public class imprimerListeetab extends JPanel implements Printable {

    List<impressionmodel_11> eleves = new ArrayList<impressionmodel_11>();
    int comp = 29;

    public imprimerListeetab(List<impressionmodel_11> eleve) {
        eleves = eleve;

        PrinterJob pj = PrinterJob.getPrinterJob();
        pj.setPrintable(imprimerListeetab.this);
        pj.printDialog();
        try {
