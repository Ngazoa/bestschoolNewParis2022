...
public class impressioLliselevetnote extends JPanel implements Printable {
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2.drawString("Enseignant :______________________________   Matière :_____________________________", 20, 160);
        ...
        g2.drawString("Liste remplissage de notes des élèves de : " + memoire.classe, 115, 190);
        g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
