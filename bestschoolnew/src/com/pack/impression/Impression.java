...
public class Impression extends JFrame implements Printable {
    ...
    private final String testmaiere = "";
    ...
    public Impression imprimer() {
        ...
        try {
            ...
            System.out.println("pdf.largeur hauteur()=" + pf.getHeight() + "  pdf.largeur obtenu=" + pf.getWidth());
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        if (pageIndex < reports.getListReports().size()) {
            ...
            g2.drawString(report.getEntete().getHierarchieLevel1(), 20, 40);
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 12));
            g2.drawString(report.getEntete().getHierarchieLevel1a(), 25, 50);
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            g2.drawString(report.getEntete().getCountry(), 440, 40);
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 12));
            g2.drawString("Republic of Cameroon", 442, 50);
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            g2.drawString(report.getEntete().getHierarchieLevel2(), 20, 65);
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 12));
            g2.drawString(report.getEntete().getHierarchieLevel2a(), 25, 75);
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            g2.drawString(report.getEntete().getDevice(), 460, 70);
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 12));
            g2.drawString("Peace-Work-Fatherland", 463, 80);
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            g2.drawString(report.getEntete().getHierarchieLevel3(), 20, 90);
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 12));
            ...
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            g2.drawString("BP " + memoire.bp + "   Tel/phone : " + report.getEntete().getNumero(), 20, 150);
            ...
            if (getPeriod().toLowerCase().contains("annuel")) {
                positionY = drawCaseAnGroupcollege(g2, positionX + 100, positionY);
            ...
            switch (i) {
                case 0:
                    if (matiere.getNoteSeq1() != 0) {
                        ...
                        g2.drawString(trimValue("Abs"), positionX + 5, positionY + 10);
                    }
                    break;
                case 1:
                    if (matiere.getNoteSeq2() != 0) {
    ...
    public int drawCaseGroup(Graphics2D g2, int positionX, int positionY, Report report, int grp, String moyclasse) {
        ...
        for (InfoMatiere matiere : groupeMatiere.getMatieres()) {
            String mat = (matiere.getMatiere());
            String m = mat.substring(0, 1).toUpperCase() + (mat.substring(1)).toLowerCase();
            g2.drawRect(positionX, positionY, 100, 15);
            g2.drawString(trimMatiere(trimDiscipline(m)), positionX + 5, positionY + 6);
            ...
            System.out.println(">>> " + matiere.getRang());
    ...
    public int drawCaseEntete(Graphics2D g2, int positionX, int positionY) {
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 100, positionY, 200, 15);
        g2.drawString("  CONTROLE CONTINU  |  DEVOIR SURVEILLE", positionX + 101, positionY + 10);
