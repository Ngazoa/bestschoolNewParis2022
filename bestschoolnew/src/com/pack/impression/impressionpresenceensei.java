 ...
 * @author Benito
 */
public class impressionpresenceensei extends JPanel implements Printable {

    List<impressionmodel_11> eleves = new ArrayList<impressionmodel_11>();
    int comp = 29;

    public impressionpresenceensei(List<impressionmodel_11> eleve) {
        eleves = eleve;

        PrinterJob pj = PrinterJob.getPrinterJob();
        pj.setPrintable(impressionpresenceensei.this);
        pj.printDialog();
        try {
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2.drawString("Liste élèves de tout l'établissement scolaire ", 115, 190);
        g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
        ...
        g2.drawString("Classe", positionX + 200 + 10, positionY);
        g2.drawString("Sexe", positionX + 340 + 10, positionY);
        g2.drawString("Conct Parents", positionX + 440 + 15, positionY);
        ...
        for (int j = pageIndex * comp; j < eleves.size() && j < comp * (pageIndex + 1); j++) {
            ...
            g2.drawString(eleves.get(j).classe(), positionX + 200 + 10, positionY);
            g2.drawString(eleves.get(j).sexe(), positionX + 340 + 10, positionY);
