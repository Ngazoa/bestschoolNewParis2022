 ...
 * @author Benito
 */
public class tableau_Honneur extends JPanel implements Printable {

    List<impressionmodel_11> eleves = new ArrayList<impressionmodel_11>();
    int comp = 29;

    public tableau_Honneur(List<impressionmodel_11> eleve) {
        eleves = eleve;

        PrinterJob pj = PrinterJob.getPrinterJob();
        pj.setPrintable(tableau_Honneur.this);
        pj.printDialog();
        try {
