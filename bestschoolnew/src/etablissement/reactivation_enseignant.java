 ...
 * @author Junior ENAMA
 */
public class reactivation_enseignant {

    public void toutes_absences_eleves() throws IOException, JSONException {
        org.json.JSONArray jsonArray = null;
        String url = memoire.liste_reactivation_enseignants;
        ...
        try {
            ...
            JOptionPane.showConfirmDialog(null, "Désolé, mais il s'averait que cet etablissement ne possede pas d'enseignants desactive", "Activation des eleves ", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        }
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            String code = s11.getString("id_enseignant");
            String classe = s11.getString("telephone");
            String note1_eleve = s11.getString("classe");
            String note2_eleve = s11.getString("cathegorie");
            String etat = s11.getString("matiere");
        ...
        String[] columnNames = {" Nom et prenom ", " Numero de telephone ", "Statut enseignant", " Classe exercice", "Code enseignant", "Matiere dispensee"};
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) {
                    ...
                    int option = JOptionPane.showConfirmDialog(null, "Souhaitez - vous reactiver l'enseignant : " + memoire.duree_cours, "Confirmation de reactivation",
    ...
    public void modifier(String ig) throws IOException, JSONException {
        String url = memoire.inserer_reactivation_enseignant;
        ...
        JOptionPane.showConfirmDialog(null, "Succes", "Activation des enseignants ", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE);
