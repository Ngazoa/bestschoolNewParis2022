 ...
 * @author Benito
 */
public class definircyclepaiement extends JDialog {
...
private JComboBox sexe,matieres,coefficient,cycle;
private JTextField nom, taille;
private javax.swing.JTable jTable1;
private javax.swing.JInternalFrame jInternalFrame2;int count=1;
private Object[][] data;
String[] id;
String[] name;
    String[] no;
...
*/
public definircyclepaiement(JFrame parent, String title, boolean modal) throws JSONException, IOException{
...
panNom.setBorder(BorderFactory.createTitledBorder("Definition des tarifs d'inscriptions"));
nomLabel = new JLabel(" Veuillez definir les differents niveaux de paiement");
...
String[] columnNames = {"N-", "Nom du niveau *","Observation 1 ","Descp (Optionnel)"
                              };
...
public void actionPerformed(ActionEvent arg0) {
    ...
    Object[] donnee = new Object[]{count+"  -- ",null,"Ne rien saisir ici","ras"};
    count++;
...
public void actionPerformed(ActionEvent arg0) {
        try {
            ...
            Logger.getLogger(definircyclepaiement.class.getName()).log(Level.SEVERE, null, ex);
...
for (int i = 0; i < count; i++) {
        ...
        videur_espace=name[i];
       videur_espace=videur_espace.trim();
        matie.add(videur_espace);
        co.add(cof[i]);
        gpe.add(gpes[i]);
 ...
 System.out.println(matie
          ...
          String url = memoire.ajout_cycle;
		...
		con.setRequestProperty("Accept-Language", "en-US,en;q=0.5");
            ...
            String urlParameters ="matiere="+matie; 
		...
		wr.close();
//        }catch(IOException ex){
//            int option = showConfirmDialog(null, "Erreur inattendue"
//                    + "\nImpossible de creer des modalites d'un nouveau cycle \nayant des propriétés vides! Bien vouloire remplir \ncorrectement les données\n\n"+ex.toString(), "Erreur de creation",
                ...
                org.json.JSONObject bj = new JSONObject(kay.trim());
                       // org.json.JSONObject jsonArray = bj.getJSONObject("erreur");
                        ...
                        String ereur = erreur.getString("erreur");
                                        ...
                                        if (ereur.equals("oui")){                              
                  JOptionPane.showMessageDialog(null,"Erreur survenue veuillez reessayer ");

                                        }else{

                       JOptionPane.showMessageDialog(null,"Niveau ou cycle de paiement \najouté avec succes");
                                                                              }
		in.close();
