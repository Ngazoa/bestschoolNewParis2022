 ...
 * @author Benito
 */
public class definition_inscriptions extends JDialog {
...
*/
public definition_inscriptions(JFrame parent, String title, boolean modal) throws JSONException, IOException{
...
nomLabel = new JLabel(" Entrer le cycle");
...
String[] columnNames = {"N-", "Tranche/Periode","Montant ","Descp(Optionnel)"
                              };
...
public void actionPerformed(ActionEvent arg0) {
    ...
    Object[] donnee = new Object[]{count+"  -- ",null,null,"r"};
    count++;
...
for (int i = 0; i < count; i++) {
 ...
 System.out.println(matie
          ...
          String url = memoire.ajout_pansion;
		...
		con.setRequestProperty("Accept-Language", "en-US,en;q=0.5");
            ...
            String urlParameters ="classe="+cycle.getSelectedItem().toString()+"&matiere="+matie+
           "&coeff="+co+"&gpe="+gpe; 
                      ...
                      System.out.println("Voici ton affichage : "+kay.trim() );
                       ...
                       // org.json.JSONObject jsonArray = bj.getJSONObject("erreur");
                        ...
                        String ereur = erreur.getString("erreur");
                                        ...
                                        if (ereur.equals("oui")){                              
                  JOptionPane.showMessageDialog(null,"Ce cycle existe deja ");

                                        }else{

                       JOptionPane.showMessageDialog(null,"modalites de paiement du cycle \najoute avec succes");
                                                                              }
		in.close();
