...
public final class MainPrintFrame extends javax.swing.JPanel {
    ...
    public MainPrintFrame(javax.swing.JTable t, javax.swing.JLabel l) {
        loadPageAttributes();
        System.err.println("EEENNNNNNTTTER");
        initFrame();
        initPage(t, l);
        //this.setBorder(new javax.swing.border.LineBorder(BACKGROUND.darker() ));
    ...
    public void loadPageAttributes() {
        ...
        papel.setImageableArea(18,18,576,977);
 /*papel.setSize(612,230);
    ...
    public void setUpPrinter() {
        try {
            if (printJob == null) {
                printJob = java.awt.print.PrinterJob.getPrinterJob();
            }
            if (pageFormat == null) {
