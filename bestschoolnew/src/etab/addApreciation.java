 ...
 * @author ASSUS GAMER
 */
public class addApreciation extends javax.swing.JDialog {

    static JTable jt;

    /**
     * Creates new form addApreciation
     */
    public addApreciation(JTable j) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!nomA.getText().isEmpty()) {
            try {
                if (Float.parseFloat(sup.getSelectedItem().toString()) <= Float.parseFloat(min.getSelectedItem().toString())) {
                    new message().error("erreur ", "Veuillez vous rassurer que la note\n"
                            + "maximale soit superieure a la note minimale");
                } else {
                    new fonctions().checkAppreciation(nomA.getText(), min.getSelectedItem().toString(),
                            sup.getSelectedItem().toString());
                    new fonctions().getAppreciation(jt);

                }
                // TODO add your handling code here:
            } catch (SQLException ex) {
                Logger.getLogger(addApreciation.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        min.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{"0"}));
        sup.setModel(new javax.swing.DefaultComboBoxModel<>(new String[]{"0"}));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addApreciation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addApreciation(jt).setVisible(true);
            }
        });
    }
