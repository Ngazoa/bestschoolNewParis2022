 ...
 * @author ASSUS GAMER
 */
public class editionClasseName extends javax.swing.JDialog {
static JTable j;
static String srang,scycle;
    /**
     * Creates new form editionClasseName
     */
    public editionClasseName(JTable j,String rang,String cycle) {
        editionClasseName.j =j;
        srang=rang;
        scycle=cycle;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ancien Nom classe : ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(nom.getText().length()<2){
           new message().error("Erreur nom", "Erreur de remplissage de champs");
            ...
            try {
                new fonctions().editionClasse(memoire.id_absence,nom.getText(),
                        new fonctionsParams().getIdcycle(cycle.getSelectedItem().toString()),rang.getSelectedItem().toString());
                new fonctions().getClasseEtablissement(j);

            } catch (SQLException ex) {
                Logger.getLogger(editionClasseName.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
// TODO add your handling code here:
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
         lnom.setText(" | "+memoire.classe);
             cycle.addItem(scycle);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editionClasseName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editionClasseName(j,srang,scycle).setVisible(true);
            }
        });
    }
