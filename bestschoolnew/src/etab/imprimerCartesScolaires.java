 ...
 * @author ASSUS GAMER
 */
public class imprimerCartesScolaires extends javax.swing.JFrame {

    private List<impressionmodel_11> eleve;

    /**
     * Creates new form imprimerCartesScolaires
     */
    public imprimerCartesScolaires() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        button1.setLabel("Imprimer cartes classe");
        ...
        if(classe.getSelectedItem().toString().equals("select")){
            ...
            try {
                eleve=new fonctions().getEleveparclassePourImpression(classe.getSelectedItem().toString());
                 if(eleve!=null){
                new carteScolaire(eleve);
                 new message().info("Operation terminee");}
            } catch (SQLException ex) {
                Logger.getLogger(imprimerCartesScolaires.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(imprimerCartesScolaires.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
