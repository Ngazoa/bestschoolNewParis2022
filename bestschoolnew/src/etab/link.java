...
public class link extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adresse Ip sans http :");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(ip, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (ip.getText().length() < 7) {
            new message().info("Adresse Ip invalide");
        } else {
            Preferences prf = Preferences.userNodeForPackage(fonctions.class);
            prf.put("lien", ip.getText());
            new message().info("Adresse Ip valide avec Succes ! \n\n"+ip.getText());
        }
        // TODO add your handling code here:
