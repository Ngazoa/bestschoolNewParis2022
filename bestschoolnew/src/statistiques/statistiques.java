 ...
 * @author Benito
 */
public final class statistiques extends JPanel implements Printable {

    int npreset = 0, nsbs = 0;
    String classe, periode;

    public statistiques(String classe, String periode) {
        this.classe = classe;
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2.drawString((" statistiques " + periode + " pour classe de :" + classe).toUpperCase(), 120, 123);
        ...
        g2.drawString("STATISTIQUES FILLES  : " + memoire.classe, positionX + 100, positionY - 10);
        positionY += 15;
        ...
        g2.drawString("STATISTIQUES GARCONS : " + memoire.classe, positionX + 100, positionY2 - 10);
        positionY2 += 15;
        g2.setColor(Color.darkGray);
        ...
        g2.drawString(("Statistiques par matière (P V) : " + memoire.classe).toUpperCase(), positionX + 100, positionu + 15);
        positionu += 30;
        ...
        for (int l = 0; l < fin; l++) {
            for (int note = 0; note < nbrematiere; note++) {
                ...
                if ((memoire.matieres.get(l + 1).equals(memoire.disciplines.get(note))) && (Double.parseDouble(memoire.note.get(note)) >= 10)) {
        ...
        for (int l = 0; l < fin; l++) {
            for (int note = 0; note < nbrematiere; note++) {
                ...
                if ((memoire.matieres.get(l + 1).equals(memoire.disciplines.get(note))) && (Double.parseDouble(memoire.note.get(note)) < 10) && (Double.parseDouble(memoire.note.get(note)) > 0)) {
                    if (memoire.sex.get(note).equals("M")) {
                        gs++;
                    }
                }
        ...
        for (int l = 0; l < fin; l++) {
            for (int note = 0; note < nbrematiere; note++) {
                if (memoire.matieres.get(l + 1).equals(memoire.disciplines.get(note)) && memoire.sex.get(note).equals("M")) {
        ...
        for (int l = 0; l < fin; l++) {
            for (int note = 0; note < nbrematiere; note++) {
                if ((memoire.matieres.get(l + 1).equals(memoire.disciplines.get(note)) && (memoire.sex.get(note).equals("F"))) && (Double.parseDouble(memoire.note.get(note)) == 0.0)) {
