...
//        idAnglo = memoire.classe.substring(0, 1).toUpperCase();
//
...
//            decompte = 0;
//            g2.drawString("Fait par akouma society e-mail: akouma.net@gmail.com", 150, 172);
//            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
//
//            /*TITRE*/
//            g2.setColor(Color.blue);
...
//            positionY += 10;
//            g2.drawString("Matricule/" + ("matricul").toUpperCase() + " : " + report.getProfile().getMatricule(), positionX + 30, positionY);
//            g2.drawString("Nom/" + ("Name").toUpperCase() + " : " + report.getProfile().getNom().toUpperCase(), positionX + 250, positionY);
//            Image image = null;
//            try {
...
//            }
//            g2.drawString("Effectif classe/" + ("class effective").toUpperCase() + ": " + effectif, positionX + 250, positionY);
//
//            /*Report Group1*/
//            positionY += 15;
...
//            g2.drawRect(positionX, positionY, 100, 15);
//            System.out.println(" matiere recu :"+matiere.getMatiere()+" "+matiere.getEnseignant());
//
...
//                MOY = (double) (produits1 + produits2 + produits3) / (double) (coefs1 + coefs2 + coefs3);
//                //cas eleve present
//            } else {
//                //cas eleve absent
//                MOY = (double) (produits1 + produits2 + produits3);
//            }
...
//            g2.setColor(Color.red);
//
//            g2.drawString("=>>" + efforts, positionX + 210, positionY + 17);
//        }
//        g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 8));
//
//        g2.setColor(Color.LIGHT_GRAY);
...
//        g2.drawString("Observation et visa du parent/ Parent's Observation", positionX + 10, positionY + (842 - (positionY + 15)) / 2 + 10);
