...
public class moyenG {
    ...
    String sclasse;
int clM = 0;
    public moyenG(String classe, String periode) {
        this.sclasse = classe;
        this.prd = periode;
    ...
    public moyenG imprimer() {
        ...
        //pj.setPrintable(moyenG.this);
        // pj.printDialog();
        try {
            //pj.setJobName("Bulletins " + memoire.classe + " pour " + memoire.choix_sequence2);
            netoyeur();
    ...
    public void netoyeur() {
        Graphics g = null;
        moyenne=new float[reports.getListReports().size()];
     ...
     */
    public int drawCaseGroup(Graphics2D g2, int positionX, int positionY, 
            Report report, int grp, String moyclasse) {
        int coef = 0;
        float prod = 0;
        ...
        if (grp == 3) {
            ...
            System.out.println(" MMMOYENNNNNE " + moyen_eleve);
            try {
                new fonctions().addEleveMoyenne(sclasse, prd,
                        report.getProfile().getMatricule(), "" + moyen_eleve);
                memoire.MOYGEN += moyen_eleve;
                System.err.println(" idexxxxxxx = "+clM);
                
                moyenne[clM]=moyen_eleve;
                clM++;
                if (moyen_eleve == 0) {
                    memoire.elevesabsent++;
                }
    ...
    public void drawTotauxGroup(Graphics2D g2, int positionX, int positionY, int coef, float produit, float moyenne, String group) {
        ...
        trimValuerep(String.valueOf(produit));
    }
