...
public class Impression extends JFrame implements Printable {
    ...
    private String period = "", titre = "";
    private String idAnglo;
    ...
    public Impression(String classe) {
        this.sclasse = classe;
    ...
    public Impression imprimer() {
        idAnglo = sclasse.substring(0, 1).toUpperCase();
        new fonctionsBulletins().classementNotes(memoire.moyenne);
        PrinterJob pj = PrinterJob.getPrinterJob();
        pj.setPrintable(Impression.this);
        // pj.printDialog();
        try {
            pj.setJobName("Bulletins " + sclasse + " pour " + getPeriod());
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        if (pageIndex < reports.getListReports().size()) {
            ...
            report = reports.getListReports().get(pageIndex);
            ...
            try {
                ...
                Logger.getLogger(com.pack.impression.Impression.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(com.pack.impression.Impression.class.getName()).log(Level.SEVERE, null, ex);
            }
            g2.drawImage(imageFili, 150, 300, 300, 300, null);
            ...
            g2.setFont(new Font(Font.SERIF, Font.ITALIC, 5));
            decompte = 0;
            g2.drawString("Fait par akouma society/BESTCHOOL e-mail: akouma.net@gmail.com -", 150, 172);
            g2.setFont(new Font(Font.MONOSPACED, Font.BOLD, 10));
            ...
            positionY += 10;
            g2.drawString("Matricule/" + ("matricul").toUpperCase() + " " + report.getProfile().getMatricule() + "19", positionX + 30, positionY);
            g2.drawString("Nom/" + ("Name").toUpperCase() + " : ", positionX + 250, positionY);
            g2.setColor(vert);

            g2.drawString(report.getProfile().getNom().toUpperCase(), positionX + 300, positionY);
            g2.setColor(Color.black);

            Image image = null;
            try {
                URL url = new URL(new login().getLinkPhotosEleves() + report.getProfile().getphoto());
            ...
            positionY += 15;
            g2.drawString("Sexe/" + ("sex").toUpperCase() + " : " + report.getProfile().getSexe(), positionX + 30, positionY);
            g2.drawString("Né(e)/" + ("born").toUpperCase() + "  : " + report.getProfile().geDate() + " à/" + ("at").toLowerCase(Locale.ITALY) + " " + report.getProfile().getLieu(), positionX + 250, positionY);
            positionY += 15;
            g2.drawString("Classe/" + ("class").toUpperCase() + " : " + report.getProfile().getClasse(), positionX + 30, positionY);
            int effectif = report.getProfile().getEffectif();
            if (effectif == 0) {
                effectif = reports.getListReports().size();
            }
            g2.drawString("Effectif/" + ("effective").toUpperCase() + ": " + effectif + "   Redoublant/repeater : " + report.getProfile().rd(), positionX + 250, positionY);

            /*Report Group1*/
            positionY += 15;
            positionY = drawCaseEntete(g2, positionX, positionY);
            //idAnglo=memoire.classe.toUpperCase().charAt(0);
            ...
            } else if (getPeriod().toLowerCase().contains("devoir")) {
            ...
            if (idAnglo.equals("F")) {
                ...
                positionY = drawCaseDiscAppreciationang(g2, positionX, positionY + 35, report);
                positionY = drawCaseObservationang(g2, positionX, positionY);
            } else {
    ...
    public void drawCaseNoteSeqGroup(Graphics2D g2, int positionX, int positionY, InfoMatiere matiere) {
        ...
        if (getPeriod().contains("troisieme")) {
            ...
            if (matiere.getNoteSeq2() < 21) {
                g2.drawString(trimValue("" + matiere.getNoteSeq2()), positionX + 92, positionY + 10);
            } else {
                g2.drawString(trimValue("Abs"), positionX + 92, positionY + 10);
            }
        } else if (getPeriod().contains("premier")) {
            if (matiere.getNoteSeq1() < 21) {
                g2.drawString(trimValue("" + matiere.getNoteSeq1()), positionX + 92, positionY + 10);
            } else {
                g2.drawString(trimValue("Abs"), positionX + 92, positionY + 10);
            }
        } else if (getPeriod().contains("quatrieme")) {
            if (matiere.getNoteSeq4() < 21) {
                g2.drawString(trimValue("" + matiere.getNoteSeq4()), positionX + 92, positionY + 10);
            } else {
                g2.drawString(trimValue("Abs"), positionX + 92, positionY + 10);
            }
        } else if (getPeriod().contains("cinquieme")) {
            if (matiere.getNoteSeq5() < 21) {
                g2.drawString(trimValue("" + matiere.getNoteSeq5()), positionX + 92, positionY + 10);
            } else {
                g2.drawString(trimValue("Abs"), positionX + 92, positionY + 10);
            }
        } else if (getPeriod().contains("sixieme")) {
            if (matiere.getNoteSeq6() < 21) {
                g2.drawString(trimValue("" + matiere.getNoteSeq6()), positionX + 92, positionY + 10);
            } else {
                g2.drawString(trimValue("Abs"), positionX + 92, positionY + 10);
            }
        }
    ...
    public void drawCaseNoteAnGroup(Graphics2D g2, int positionX, int positionY, InfoMatiere matiere) {
        for (int i = 0; i != 6; i++) {
            if ((i + 1) % 3 == 0) {
                g2.drawRect(positionX, positionY, 34, 15);
            } else {
                g2.drawRect(positionX, positionY, 33, 15);
            }
            switch (i) {
                case 0:
                    if (matiere.getNoteSeq1() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq1()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
                case 1:
                    if (matiere.getNoteSeq2() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq2()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
                case 2:
                    if (matiere.getNoteSeq3() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq3()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
                case 3:
                    if (matiere.getNoteSeq4() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq4()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
                case 4:
                    if (matiere.getNoteSeq5() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq5()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
                case 5:
                    if (matiere.getNoteSeq6() < 21) {
                        g2.drawString(trimValue("" + matiere.getNoteSeq6()), positionX + 5, positionY + 10);
                    } else {
                        g2.drawString(trimValue("Abs"), positionX + 10, positionY + 10);
                    }
                    break;
    ...
    public int drawCaseGroup(Graphics2D g2, int positionX, int positionY, Report report, int grp, String moyclasse) {
        ...
        for (InfoMatiere matiere : groupeMatiere.getMatieres()) {
            g2.drawRect(positionX, positionY, 100, 15);
            System.out.println(" matiere recu :" + matiere.getMatiere() + " " + matiere.getEnseignant() + " numreo " + oo);
            oo++;
            ...
            if (getPeriod().toLowerCase().contains("annuel")) {
                ...
                if (nbre != 0) {
                    ...
                    if (not >= 10) {
                        ...
                        g2.drawString(trimValuerep("" + (not)), positionX + 100 + 200 + 40 + 10, positionY + 10);
                        if (not < 8) {
                            efforts += matiere.getMatiere() + "<BR>";
                        }
                        g2.setColor(Color.black);
                    }

                    g2.drawString(trimValuerep("" + ((not) * matiere.getCoef())), positionX + 100 + 200 + 40 + 40 + 10, positionY + 10);
        ...
        if (grp == 3) {
            ...
            if (app.equals("/")) {
                if (idAnglo.equals("F")) {
                    app = appreciationanglo("" + (produits1 + produits2 + produits3) / (coefs1 + coefs2 + coefs3), decompte);
                } else {
     ...
     * @param moyClasse La moyenne de la classe
     */
    public int drawCaseTotaux(Graphics2D g2, int positionX, int positioY, int coef, double prod,
            double moyenne, String rang, String appreciation, String moyClasse) {
        Color vert = new Color(0, 102, 0);
        ...
        g2.drawString("Moyenne /Average  " + getStatusPeriod() + " /20", positionX + 100 + 30, positionY + 10);
        ...
        g2.setColor(Color.white);
        g2.drawRect(positionX + 100 + 200 + 40 + 40 + 40, positionY, 40, 15);
        float moy = (float) moyenne;
        BigDecimal valeur = (new BigDecimal(moy)).setScale(2, BigDecimal.ROUND_HALF_DOWN);
        float moyen_eleve = valeur.floatValue();

        for (int i = 0; i < memoire.moyenne.length; i++) {
            // System.out.println(" TABLEAU >>><<<< "+Arrays.toString(memoire.moyenne)+"<<< "+moy);
            if (memoire.moyenne[i] == moyen_eleve) {
                int kl = (i + 1);
                g2.drawString("" + kl, positionX + 100 + 200 + 40 + 40 + 40 + 15, positionY + 10);
            }
        }
        ...
        g2.drawString("M. Classe/class ave/20", positionX + 5, positionY + 10);
        g2.setColor(Color.LIGHT_GRAY);
        ...
        positionY += 17;
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX + 15, positionY, 100, 20);
        g2.setColor(Color.black);
        g2.drawRect(positionX + 15, positionY, 100, 20);
        g2.drawString("Moy premier/first", positionX + 20, positionY + 10);
        g2.drawString("Des efforts s'imposent en/must work :", positionX + 220, positionY);

        g2.setFont(new Font(Font.MONOSPACED, Font.ITALIC, 7));
        if (efforts.equals("")) {
            g2.setColor(Color.blue);
            g2.drawString(" Aucune Observation/ Nothing", positionX + 210, positionY + 17);

        } else {
            g2.setColor(Color.red);
            int positionX1 = positionX;
            int positionY1 = positionY;
            String[] pattern1 = efforts.split("<BR>");
            int j = 1, e = 1, se = 1;

            for (String motif1 : pattern1) {
                if (j % 4 != 0) {
                    g2.drawString("-" + motif1.toUpperCase(), positionX1 + 210, positionY1 + (10 * se));
                    j++;
                    se++;
                } else {
                    se = 2;
                    positionX1 = positionX1 + 110;
                    positionY1 = positionY1;
                    g2.drawString("-" + motif1.toUpperCase(), positionX1 + 210, positionY1 + (10 * e));
                    j++;
                }
            }
        }
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 100, positionY, 100, 20);
        g2.drawString(trimValuerep(memoire.MOYP), positionX + 100 + 42, positionY + 10);
        efforts = "";
        positionY += 12;
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX + 25, positionY + 5, 100, 20);
        g2.setColor(Color.black);
        g2.drawRect(positionX + 25, positionY + 5, 100, 20);
        g2.drawString("Moy dern./last.", positionX + 30, positionY + 15);
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX + 100, positionY + 5, 100, 20);
        g2.setColor(Color.black);
        g2.drawRect(positionX + 100, positionY + 5, 100, 20);
        g2.drawString(trimValuerep(memoire.MOYD), positionX + 100 + 42, positionY + 15);
    ...
    public int drawCaseDiscAppreciationang(Graphics2D g2, int positionX, int positionY, Report report) {
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX, positionY, 276, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 276, 15);
        g2.drawString("SUBJECT", positionX + 60, positionY + 10);

        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX + 276, positionY, 279, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX + 276, positionY, 279, 15);
        g2.drawString("WORK APPREC.".toUpperCase(), positionX + 276 + 90, positionY + 10);
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 69, 15);
        g2.drawString("ABSENCE(hour)", positionX + 5, positionY + 10);
        g2.drawRect(positionX, positionY + 15, 69, 15);
        g2.drawString("" + (calculHours(report)), positionX + 33, positionY + 15 + 10);
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 69, positionY, 69, 15);
        g2.drawString("WARNING", positionX + 69 + 5, positionY + 10);
        g2.drawRect(positionX + 69, positionY + 15, 69, 15);
        ...
        g2.drawRect(positionX + 276, positionY, 34, 15);
        g2.drawString("VG", positionX + 276 + 15, positionY + 10);
        g2.drawRect(positionX + 276 + 34, positionY, 34, 15);
        g2.drawString("GO", positionX + 276 + 34 + 15, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 34, positionY, 34, 15);
        g2.drawString("FG", positionX + 276 + 34 + 34 + 15, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 34 + 34, positionY, 35, 15);
        g2.drawString("AV", positionX + 276 + 34 + 34 + 34 + 10, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 35 + 34 + 34, positionY, 34, 15);
        g2.drawString("IS", positionX + 276 + 35 + 34 + 34 + 34 + 10, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 35 + 34 + 34 + 34, positionY, 36, 15);
        g2.drawString("VI", positionX + 276 + 35 + 34 + 34 + 34 + 34 + 10, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 35 + 34 + 34 + 34 + 36, positionY, 36, 15);
        g2.drawString("WEEk", positionX + 276 + 35 + 34 + 36 + 34 + 34 + 34 + 10, positionY + 10);
        g2.drawRect(positionX + 276 + 34 + 35 + 34 + 34 + 34 + 36 + 36, positionY, 36, 15);
        g2.drawString("NULL", positionX + 276 + 35 + 34 + 34 + 34 + 34 + 36 + 36 + 10, positionY + 10);

        g2.drawRect(positionX + 276, positionY + 15, 55, 15);
        g2.drawString("Encouragem.", positionX + 276 + 5, positionY + 15 + 10);

        g2.drawRect(positionX + 276 + 55, positionY + 15, 55, 15);
        g2.drawString("Congratu.", positionX + 276 + 55 + 5, positionY + 15 + 10);

        g2.drawRect(positionX + 276 + 55 + 55, positionY + 15, 65, 15);
        g2.drawString("Hounour's roll.", positionX + 276 + 55 + 55 + 1, positionY + 15 + 10);

        g2.drawRect(positionX + 276 + 55 + 55 + 65, positionY + 15, 55, 15);
        g2.drawString("Warning", positionX + 276 + 55 + 55 + 65 + 1, positionY + 15 + 10);
    ...
    public int drawCaseObservation(Graphics2D g2, int positionX, int positionY) {
        if (period.trim().contains("devoir")) {
    ...
    public int drawCaseObservationang(Graphics2D g2, int positionX, int positionY) {
        if (period.trim().contains("devoir")) {
            return drawCaseObservationSequenceang(g2, positionX, positionY);
        } else if (period.trim().contains("trimestre")) {
            return drawCaseObservationTrimestreang(g2, positionX, positionY);
        } else if (period.trim().contains("annuel")) {
            return drawCaseObservationAnnuelang(g2, positionX, positionY);
        }
        return positionY;
    }
    ...
    public int drawCaseObservationTrimestre(Graphics2D g2, int positionX, int positionY) {
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 276, 15);
        g2.drawString("Observation et visa du parent/ Parent's Observation", positionX + 10, positionY + 10);
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 276, positionY, 279, 15);
        g2.drawString("Observation et visa du principal/ principal's observation", positionX + 276 + 10, positionY + 10);
    ...
    public int drawCaseObservationTrimestreang(Graphics2D g2, int positionX, int positionY) {
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX, positionY, 276, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 276, 15);
        g2.drawString("PARENT'S OBSERVATION ", positionX + 10, positionY + 10);
        g2.drawRect(positionX, positionY, 276, 842 - (positionY + 15));
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 276, positionY, 279, 15);
        g2.drawString("OBSERVATION AND PRINCIPAL'S VISA", positionX + 276 + 10, positionY + 10);
        g2.drawRect(positionX + 276, positionY, 279, 842 - (positionY + 15));
     ...
     * @param positionY coordonn�e de l'ordonn�e Y
     */
    public int drawCaseObservationSequenceang(Graphics2D g2, int positionX, int positionY) {
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX, positionY, 276, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 276, 15);
        g2.drawString("OBSERVATION AND  GENERAL'S VISA", positionX + 10, positionY + 10);
        g2.drawRect(positionX, positionY, 276, (842 - (positionY + 15)) / 2);
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY + (842 - (positionY + 15)) / 2, 276, 15);
        g2.drawString("PARENT'S OBSERVATION ", positionX + 10, positionY + (842 - (positionY + 15)) / 2 + 10);
        g2.drawRect(positionX, positionY + (842 - (positionY + 15)) / 2, 276, (842 - (positionY + 15)) / 2);
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX + 276, positionY, 279, 15);
        g2.drawString("OBSERVATION AND PRINCIPAL TEACHER'S VISA", positionX + 276 + 10, positionY + 10);
        g2.drawRect(positionX + 276, positionY, 279, 842 - (positionY + 15));
     ...
     * @param positionY coordonn�e de l'ordonn�e Y
     */
    public int drawCaseObservationAnnuelang(Graphics2D g2, int positionX, int positionY) {
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX, positionY, 276, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 276, 15);
        g2.drawString("OBSERVATION AND PARENT's VISA", positionX + 10, positionY + 10);
        g2.drawRect(positionX, positionY, 276, 842 - (positionY + 15));
    ...
    public int drawCaseEntete(Graphics2D g2, int positionX, int positionY) {
        ...
        g2.setColor(Color.black);
        g2.drawRect(positionX, positionY, 100, 15);
        g2.drawString("Matiere/Subject", positionX + 10, positionY + 10);
        g2.setColor(Color.LIGHT_GRAY);
        g2.fillRect(positionX + 100, positionY, 300, 15);
        g2.setColor(Color.black);
        g2.drawRect(positionX + 100, positionY, 200, 15);
        g2.drawString("DEVOIR SURVEILLE/", positionX + 45 + 70, positionY + 10);
        g2.drawString("Test-Exam", positionX + 135 + 70, positionY + 10);
    ...
    public Impression setPeriod(String period) throws Exception {
        ...
        if (sclasse.substring(0, 1).equalsIgnoreCase("F")) {
            ...
            if (period.trim().toLowerCase().contains("sequence1")) {
                ...
                this.period = "Bulletin du quatrieme devoir";
            } else if (period.trim().toLowerCase().contains("sequence5")) {
                this.period = "Bulletin du cinquieme devoir";
            } else if (period.trim().toLowerCase().contains("sequence6")) {
                this.period = "Bulletin du sixieme devoir";
            } else if (period.trim().toLowerCase().contains("trimestre1")) {
                this.period = "Bulletin du premier trimestre";
            } else if (period.trim().toLowerCase().contains("trimestre2")) {
                this.period = "Bulletin du deuxieme trimestre";
    ...
    public String appreciationanglo(String Val, int decompte) {
        String app = "";
        try {
            if (!Val.trim().equals("")) {
                if ((0 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 4)) {
                    app = "nul<br>Subjects Passed:" + decompte;
                } else if ((4 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 5.5)) {
                    app = "Poor<br>Subjects Passed:" + decompte;
                } else if ((5.5 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 7.5)) {
                    app = "Very insuff.<br>Subjects Passed:" + decompte;
                } else if ((7.5 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 9)) {
                    app = "Insuffisance<br>Subjects Passed:" + decompte;
                } else if ((9 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 10)) {
                    app = "Mediocre<br>Subjects Passed:" + decompte;
                } else if ((10 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 12)) {
                    app = "Average<br>Subjects Passed:" + decompte;
                } else if ((12 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 14)) {
                    app = "Well-enough<br>Subjects Passed:" + decompte;
                } else if ((14 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 17)) {
                    app = "Good<br>Subjects Passed:" + decompte;
                } else if ((17 <= Float.parseFloat(Val)) && (Float.parseFloat(Val) < 20)) {
                    app = "Very good<br>Subjects Passed:" + decompte;
                } else if (20 == Float.parseFloat(Val)) {
                    app = "Perfect<br>Subjects Passed:" + decompte;
                } else {
                    app = "ABSENT";
